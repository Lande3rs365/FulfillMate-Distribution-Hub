...
import {
  ...
  ArrowRightLeft, Ship, RotateCcw, LogOut, Building2, ChevronsUpDown, Tag, User, Settings } from
"lucide-react";
    ...
    <aside className={cn(
      ...
      <div className="p-4 border-b border-sidebar-border flex items-center gap-3">
        ...
        <div className="overflow-hidden">
            <h1 className="text-sm font-bold text-sidebar-accent-foreground truncate">JFlowers
      ...
      {companies.length > 0 && <div className="px-2 py-2 border-b border-sidebar-border">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className={cn("w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors hover:bg-sidebar-accent", collapsed && "justify-center")}>
